  This is an old style WDM driver filter that I found on the old hard drive. I developed it in 2008 in one day to test some ideas. The interesting feature of the driver is using an asynchronous processing to speed up filtering.
